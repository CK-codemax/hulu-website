  ...
  <>
   <div className="w-full pt-8 pb-6 bg-gradient-to-b from-[#1ce783] to-gray-900 ">
    ...
    <div className="bg-black pb-10 pt-28">
         ...
         <p className="text-white mb-4 font-bold text-[30px] text-nowrap sm:text-[35px] xl:text-[40px] text-center">All The TV You Love</p>

         <p className="text-white text-wrap w-[90%] sm:w-[75%] lg:w-[800px] text-center mx-auto">Watch full seasons of exclusive streaming series, current-season episodes, hit movies, Hulu Originals, kids shows, and more.</p>
    ...
    <div className="bg-black pb-10 pt-28">
         <p className="text-[#1ce783] mb-4 px-8 text-center text-wrap text-xs font-semibold uppercase tracking-widest">HULU + LIVE TV, NOW WITH DISNEY+ AND ESPN+, ALL WITH ADS</p>

         <p className="text-white mb-4 px-8 font-bold text-[30px] sm:text-[40px] text-center">Live TV Makes It Better</p>

         <p className="text-white text-wrap w-[85%] sm:w-[75%] xl:w-[800px] text-center mx-auto mb-4">Get 95+ top channels on Hulu (With Ads) + Live TV with your favorite live sports, news, and events - plus the entire Hulu streaming library. With Unlimited DVR, store Live TV recordings for up to nine months and fast-forward through your DVR content. Access endless entertainment with Disney+ and live sports with ESPN+.</p>

         <Link className="text-gray-800 block mx-auto mb-5 bg-[#1ce783] hover:bg-opacity-75 w-[240px] text-center hover:bg-[#00ed82] transition-colors duration-500 ease-in-out text-sm py-4 rounded-md font-bold uppercase tracking-widest " href={'/'}>get hulu + live tv</Link>

         <Link href={'/'} className="text-gray-400 mx-auto mb-5 text-wrap text-center w-[92%] sm:w-[75%] xl:w-[1000px] block underline text-xs">
       ...
       <div className="text-gray-300 w-full cursor-default justify-center underline flex items-center space-x-2">
        <p className="uppercase font-semibold text-l">view channels in your area&rarr; </p>
  </div>
