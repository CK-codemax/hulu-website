...
export default function ImageSelector() {
  ...
  return (<div className="relative w-full min-h-screen h-[800px] bg-[#0b0c0f] pt-5 pb-20">
        <div className="absolute z-10 top-[75px] left-[50%] -translate-x-[50%] xl:-translate-x-[0] mx-auto xl:top-[200px] xl:left-24 flex space-x-6">
         ...
         {opened === 'live-sports' && (<div className={`absolute ${opened === 'live-sports' ? '-translate-y-10 transition-transform duration-1000 ease-out' : 'translate-y-0'} w-full top-[180px] left-[50%] -translate-x-[50%] xl:-translate-x-[0] xl:left-24 xl:top-[280px]`}>
        ...
        {opened === 'breaking-news' && (<div className="absolute w-full top-[180px] left-[50%] -translate-x-[50%] xl:-translate-x-[0] xl:left-24 xl:top-[280px]">
         ...
         {opened === 'biggest-events' && (<div className="absolute w-full top-[180px] left-[50%] -translate-x-[50%] xl:-translate-x-[0] xl:left-24 xl:top-[280px]">
